...
public class FlowchartStylePreferences {
    ...
    static {
        ...
        schemes.put(ChartNodeType.MOVE, new GraphvizStyleScheme(Color.GREEN, Color.BLACK, Shape.NOTE));
        schemes.put(ChartNodeType.ADD, new GraphvizStyleScheme(Color.GREEN, Color.BLACK, Shape.NOTE));
        ...
        schemes.put(ChartNodeType.PERFORM_TEST, new GraphvizStyleScheme(Color.WHITE, Color.BLACK, Shape.UNDERLINE));
