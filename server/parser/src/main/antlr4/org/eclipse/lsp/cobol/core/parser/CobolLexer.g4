...
GUID : [0-9a-f]{8} MINUSCHAR [0-9a-f]{4} MINUSCHAR [0-9a-f]{4} MINUSCHAR [0-9a-f]{4} MINUSCHAR [0-9a-f]{12} MINUSCHAR;
...
DIALECT_MARKER: UNDERSCORECHAR DIALECT_MARKER UNDERSCORECHAR;
